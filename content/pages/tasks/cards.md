...
category: "tasks"
audience: ["all"]
tags: ["hr", "finance", "it", "facilities", "policy", "deia", "student", "tasks"]
summary: "Utilize Your Card\n\nEmployee Credit Cards – the college utilizes JP Morgan Chase credit cards for employee purchasing.  In addition to “brick and mortar” purchases, online purchases are a good way to utilize this payment method."
sourceUrl: "https://cyan-tangerine-w282.squarespace.com/cards"
---
...
**Purchasing Limit** - Credit cards are issued to staff with a credit limit of $5,000.00 and a single transaction limit of $3,000.00. For support, please email any questions to [jpmorgan@whitman.edu](mailto:jpmorgan@whitman.edu). Please see [instructions for reconciling your monthly credit card charges](https://cyan-tangerine-w282.squarespace.com/cards).

**Important Purchasing “Red Flags”**

-   **Gift Cards** are considered taxable income. For gift cards given to Whitman community members: If you've given a gift card, gift certificate or cash card of any value to a student, staff or faculty member of Whitman College, please fill out this [gift card form](https://docs.google.com/forms/d/e/1FAIpQLScyskt2PzWinC5uZGfTPgoBoge4g6Rp36fawtmwS2nv5luICw/viewform). For gift cards given to non-Whitman community members: Please fill out the form only if the gift card, gift certificate or cash card exceeds $75 per individual.
...
Consider **capturing your receipt** (if it’s a paper receipt), by taking a photograph - and then save it as a PDF. If the receipt is emailed to you, save it as a PDF ([Go Full Screen](https://chrome.google.com/webstore/detail/gofullpage-full-page-scre/fdpohaocaechififmbbbbbknoalclacl?hl=en) is also a handy tool).
...
-   [Combine all PDF documents into one master document](/folio)


**Review Your Paperwork: Screen, Sum, and Stamp**

Review your receipts and transactions for accuracy (do they add up to the same amount?); if a tip has been added, that both tip amount and total amount are included. Do the math for the Business Office, don’t ask them to do it for you. “Stamp” each receipt or piece of paperwork with the requisite information (please see [Stamping Your Paperwork](/stamps)).

-   ## Screen

Review your documents to ensure that all of the requisite information is included on each page.

-   ## Sum

Another way of saying this is: “Do the math.” Don’t make the Business Office do it for you.

-   ## Stamp

Stamp your receipts with date, amount, and purpose of purchase.
